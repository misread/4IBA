...
namespace ServiceStation
{
    public partial class clientAdd : Form
    {
        ...
        private String SQLInsert = "INSERT INTO Clients (firstname, lastname, phone, email, country, city, street, house, flat) VALUES (@firstname, @lastname, @phone, @email, @country, @city, @street, @house, @flat)";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("The Client Added");                
                connection.Close();
                this.Close();
            }
        ...
        private void clientAdd_Activated(object sender, EventArgs e)
        {
        ...
        private void clientAdd_KeyDown(object sender, KeyEventArgs e)
        {
